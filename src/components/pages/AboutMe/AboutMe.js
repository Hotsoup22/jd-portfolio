  ...
  return (
    <div>
      ...
      <footer className="buttonContainer-div">
        <a href="https://github.com/Hotsoup22"><img src={gitHubIcon} alt="github link" width="70" height="30"/></a>
        <a href="https://www.linkedin.com/in/jose-diaz-07043220b/"><img src={linkInIcon} alt="github link" width="70" height="26"/></a>
      </footer>
